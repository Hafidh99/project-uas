                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select name="category" class="custom-select">
                                        ...
                                        <option {{ $recipe->category == "kesehatan" ? "selected" : "" }} value="kesehatan">Kesehatan</option>
                                        <option {{ $recipe->category == "kecantikan" ? "selected" : "" }} value="kecantikan">Kecantikan</option>
                                        <option {{ $recipe->category == "ibu dan anak" ? "selected" : "" }} value="ibu dan anak">Ibu dan Anak</option>
                                    </select>
                                </div>
                            </div>
                        </div>
